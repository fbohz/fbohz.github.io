...
> What is GraphQL? It is a server language that wraps around an existing database to make requests differently...GraphQL can be very challenging since there's so much to learn at the beginning. 
