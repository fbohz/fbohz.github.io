...
BIG O is important for big applications. Scalable code is thinking long term.

Good developers make these decisions efficiently.
...
const large = new Array(199999).fill('nemo') 
    ...
    // this is performance in speed not crucial but for demo purposes.
