...
> What is GraphQL? It is a server language that wraps around an existing database to make requests differently. I implemented GraphQL on the latest iteration of the [Yijing-Ball-Z](https://yijingballz.herokuapp.com/) app. 
